...
const sucre = () => {
  const handlePress = () => {
    Linking.openURL("https://maps.app.goo.gl/bUEfc1abPLvVnJZj7");
  };
    ...
    <>
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.description}>
          Esta plaza rinde homenaje al Mariscal Sucre y es un popular punto de
          encuentro para los habitantes locales.
        </Text>
