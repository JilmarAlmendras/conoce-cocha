  ...
  return (
    <>
      ...
      <View style={styles.container}>
        <Text style={styles.title}>Parque Nacional Tunari</Text>
        <Image
          source={{
            uri: "https://upload.wikimedia.org/wikipedia/commons/0/08/Laguna_del_Parque_Nacional_Tunari%2C_Cochabamba%2C_Bolivia.jpg",
          }}
