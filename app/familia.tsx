...
const familia = () => {
  const handlePress = () => {
    Linking.openURL("https://maps.app.goo.gl/F39wpAaKoETcF9JW7");
  };
  ...
  return (
    <>
      ...
      <View style={styles.container}>
        <Text style={styles.title}>Parque de la Familia</Text>
        <Image
          source={{
            uri: "https://www.boliviaentusmanos.com/turismo/imagenes/parque-de-la-familia-1.jpg",
          }}
