  ...
  return (
    <>
      ...
      <View style={styles.container}>
        <Text style={styles.title}>Villa Tunari</Text>
        <Image
          source={{
        ...
        <Text style={styles.description}>
          Villa Tunari es un destino popular en el trópico de Cochabamba,
          conocido por sus paisajes exuberantes y el Parque Nacional Carrasco.
        </Text>
